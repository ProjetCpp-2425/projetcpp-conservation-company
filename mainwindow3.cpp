...
void MainWindow3::startScoreCalculationTimer()
{
    // Set up a timer to call calculateScores periodically
    QTimer *timer = new QTimer(this);
    connect(timer, &QTimer::timeout, this, &MainWindow3::calculateScores);
...

{
  ...
  // Timer setup
  QTimer *timer = new QTimer(this);
  connect(timer, &QTimer::timeout, this, &MainWindow3::onTimerTimeout);
  timer->start(65000); // Trigger every 5 seconds
...
void MainWindow3::calculateScores()
{
    QSqlQuery query;
    query.prepare("SELECT IDENTIFIANTF, DATETIMEF, NOMF FROM fournisseurs"); // Modify the query to include supplier name
    ...
    if (query.exec()) {
        ...
        while (query.next()) {
            ...
            qDebug() << "fournisseurs ID: " << id << " Name: " << name << " Score: " << score;
        }
...
void MainWindow3::updateScoreDisplay()
{
...
void MainWindow3::on_pushButton_supprimer_clicked()
{
...
void MainWindow3::on_pushButton_trier_clicked()
{
...
void MainWindow3::on_pushButton_modifier_clicked()
{
    ...
    QSqlQuery query;
    query.prepare("SELECT NOMF, PRENOMF, TELEPHONEF, EMAILF FROM fournisseurs WHERE IDENTIFIANTF = :identifiant");
...
void MainWindow3::on_pushButton_enregistrer_clicked()
{
...
void MainWindow3::on_pushButton_rechercher_clicked()
{
...
/*void MainWindow3::on_pushButton_statistiques_clicked()
{
...
void MainWindow3::on_pushButtonB_clicked()
{
...
{
    window2 = new MainWindow2(this); // Crée une nouvelle instance si elle n'existe pas
